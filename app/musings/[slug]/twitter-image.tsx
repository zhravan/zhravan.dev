...
export async function generateStaticParams() {
  const allThoughts = getContentByType('thoughts', false);
...
export default async function Image({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const thought = getContentItemBySlug('thoughts', slug, true);

  const title = thought?.title || 'Musing';
