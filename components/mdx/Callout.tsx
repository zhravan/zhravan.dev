...
// GitHub-style colors and icons
const calloutStyles: Record<CalloutType, { color: string; icon: ReactNode; title: string }> = {
  note: {
    color: '#1f6feb',
    icon: (
...
// Convenience components matching GitHub's alert types
...
// Aliases
export const Info = Note;
export const Danger = Caution;
