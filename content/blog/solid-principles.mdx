...
![Alt Image](https://iamskb258154309.files.wordpress.com/2020/09/dont-be-stupid-grasp-solid-north-east-php-1-638-1.jpg)
**_“Think Twice, Code Once”_**

Hi everyone! This is a revised version of my article from [my personal blog](https://ohmyscript.com/2020/10/06/solid-principles-write-solid-programs-avoid-stupid-programs/).

Previously, in [my last article](https://dev.to/imshravan/must-know-basic-engineering-principles-for-programming-383), I had explained some of the [must-know fundamental programming principles](https://dev.to/imshravan/must-know-basic-engineering-principles-for-programming-383), which are applicable in any programming paradigm that you follow. Be it **_Functional or Object-Oriented paradigm/programming_**, those serve as the **primary fundamentals**.
...
![AltImage](https://iamskb258154309.files.wordpress.com/2020/10/captured-4-1.png?w=1024)
...
![altIMAGE](https://iamskb258154309.files.wordpress.com/2020/10/liskov-substition-principle-565x600-1.png?w=283)
...
![altimagee](https://iamskb258154309.files.wordpress.com/2020/10/gr8conf-2015-spring-boot-and-groovy-what-more-do-you-need-24-638.jpg) Voila! Spring Boot developers! Inversion of Control made sense!! Didn’t it?
