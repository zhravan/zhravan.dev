export const frontmatter = {
  title: "Must Know: Software Engineering Principles for Programming",
  date: "2020-09-06",
  description:
...
If you like the article, hit the like button, share the article and subscribe the blog. If you want me to write article on specific domain / technology I am provisioned in, feel free to drop a mail at [shravan [at] eclosion [dot] in](mailto:shravan@eclosion.in)
