export const frontmatter = {
  title: "On Freelancing: My lessons & learnings",
  date: "2025-12-17",
  description:
...
If you like the article, hit the like button, share the article and subscribe the blog. If you want me to write an article on a specific domain or technology, feel free to drop a mail at [shravan [at] eclosion [dot] in](mailto:shravan@eclosion.in)
